...
const SANDBOX_LEVELS = ["none", "permissive", "moderate", "strict"] as const
...
export interface NormalizedAgentSettings {
  ...
  locale: string
  // Global sandbox
  sandboxLevel: (typeof SANDBOX_LEVELS)[number]
...
export function normalizeAgentSettings(rawSettings?: AgentSettingsInput): NormalizedAgentSettings {
  ...
  return {
    ...
    sandboxLevel: readEnum(settings, "sandboxLevel", SANDBOX_LEVELS, DEFAULT_AGENT_SETTINGS.sandboxLevel),
