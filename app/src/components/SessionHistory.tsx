    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ flex: 1 }}>
          <div style={{
            ...
            {projectName}
            <span style={{ color: "var(--text-secondary)", opacity: 0.4, margin: "0 6px" }}>{"\u00B7"}</span>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: 16, display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        {!loading && sessions.length === 0 && (
          <div style={{ textAlign: "center", padding: 60, color: "var(--text-secondary)", opacity: 0.4 }}>
        ...
        {sessions.map(session => (
          ...
          >
            ...
            <div style={{ fontSize: 11, color: "var(--text-secondary)", opacity: 0.6, display: "flex", gap: 12 }}>
