    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          width: "85vw", maxWidth: 420, zIndex: 201,
      ...
      >
            ...
            {tabs.map((tab) => (
              <button
                ...
                style={{
                  ...
                  border: "none",
                  background: activeTab === tab.id ? "rgba(96,165,250,0.15)" : "transparent",
              ...
              >
                ...
                {tab.count > 0 && (
                  <span style={{
                    ...
                    background: activeTab === tab.id ? "rgba(96,165,250,0.2)" : "rgba(255,255,255,0.06)",
                  }}>
                    {tab.count}
                  </span>
                )}
          ...
          {activeTab === "urls" ? (
              ...
              urlEntries.map((entry, i) => (
                <div key={i} style={{
                  ...
                  <a href={entry.url} target="_blank" rel="noopener noreferrer" style={{
                    ...
                    color: "#a78bfa", wordBreak: "break-all", textDecoration: "none", marginBottom: 6,
                  }}>
                    {entry.url}
                  </a>
                  <pre style={{
                    margin: 0, fontSize: 11, fontFamily: "'JetBrains Mono', monospace",
                    color: "rgba(255,255,255,0.5)", whiteSpace: "pre-wrap", wordBreak: "break-word",
                    lineHeight: 1.4, borderTop: "1px solid rgba(255,255,255,0.06)", paddingTop: 6,
                  }}>
                    {entry.context}
                  </pre>
                </div>
            ...
            blocks.map((block, i) => (
              <div key={i} style={{
                ...
                <div style={{
                  fontSize: 9, color: "rgba(255,255,255,0.2)", marginBottom: 4,
        ...
        <div style={{
          padding: "8px", textAlign: "center", fontSize: 10, color: "rgba(255,255,255,0.15)",
